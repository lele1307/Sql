...
CONSTRAINT fk_like_person FOREIGN KEY (username) REFERENCES Person(username) ON DELETE CASCADE,
CONSTRAINT fk_like_post FOREIGN KEY (postId) REFERENCES Post(id) ON DELETE CASCADE,
CONSTRAINT fk_like_topic FOREIGN KEY (topicId) REFERENCES Topic(id) ON DELETE CASCADE
);
